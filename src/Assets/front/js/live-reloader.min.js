...
var Reloader = /*#__PURE__*/function () {
  function Reloader(nonce, postId, postHash, timeouts, isDebugMode) {
    ...
    _defineProperty(this, "postId", void 0);
    _defineProperty(this, "postHash", void 0);
    _defineProperty(this, "indicator", void 0);
    _defineProperty(this, "isInactive", void 0);
    _defineProperty(this, "isMouseMoved", void 0);
    _defineProperty(this, "idGeneratorData", void 0);
    _defineProperty(this, "isDebugMode", false);
    _defineProperty(this, "nextRequestTimerId", void 0);
    _defineProperty(this, "timeouts", void 0);
    _defineProperty(this, "ajaxRequestTime", void 0);
    this.items = {};
    this.nonce = nonce;
    this.postId = postId;
  ...
  _createClass(Reloader, [{
    ...
    value: function debug(message) {
      ...
      console.log("AVF Live Reload: ".concat(message), args);
    }
  }, {
    ...
    value: function getCssTag(uniqueId) {
      return this.getStylesRoot().querySelector("style[data-advanced-views-asset=".concat(uniqueId, "]"));
    }
  }, {
    key: "updateTag",
    value: function updateTag(type, uniqueId, code) {
      ...
      var tag = 'style' === type ? this.getCssTag(uniqueId) : document.querySelector("".concat(type, "[data-advanced-views-asset=").concat(uniqueId, "]"));
      if (null === tag && '' !== code) {
    ...
    value: function processChangedItems(changedItems) {
      ...
      Object.keys(changedItems).forEach(function (itemId) {
        if (false === Object.hasOwn(_this2.items, itemId)) {
          console.log("Advanced Views Framework - changed item with id: ".concat(itemId, " not found."));
          return;
        }
        var item = _this2.items[itemId];
        var codeHashes = changedItems[itemId].codeHashes || {};
        var css = true === Object.hasOwn(changedItems[itemId], 'css') ? changedItems[itemId].css : null;
        var js = true === Object.hasOwn(changedItems[itemId], 'js') ? changedItems[itemId].js : null;
        var html = true === Object.hasOwn(changedItems[itemId], 'html') ? changedItems[itemId].html : null;
    ...
    value: function processResponse(data) {
      this.debug('Server responded', {
        _requestTimeInSeconds: (Date.now() - this.ajaxRequestTime.getTime()) / 1000,
        data: data
      });
      ...
      if (true === Object.hasOwn(data, 'isPageChanged')) {
    ...
    value: function addItem(item) {
      if (false === Object.hasOwn(this.idGeneratorData, item.uniqueId)) {
        this.idGeneratorData[item.uniqueId] = 0;
      }
      this.idGeneratorData[item.uniqueId]++;
      var itemId = "".concat(item.uniqueId, "_").concat(this.idGeneratorData[item.uniqueId]);
