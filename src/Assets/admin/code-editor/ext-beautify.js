  ...
  exports.beautify = function (session) {
    ...
    var _loop = function _loop() {
      ...
      if (typeof token !== "undefined") {
        ...
        if (value) {
          // todo _custom begin
          var isOpeningTwig = 'meta.tag.twig' === token.type && '{%' === value;
          var isClosingTwig = 'meta.tag.twig' === token.type && '%}' === value;
          var twigKeyword = '';
          if (isOpeningTwig || isClosingTwig) {
            rowTokens.forEach(function (rowToken) {
              if ('keyword.control.twig' !== rowToken.type) {
                return;
              }
              twigKeyword = rowToken.value;
            });
          }
          switch (twigKeyword) {
            case 'if':
