...
var CodeEditor = /*#__PURE__*/function () {
  ...
  _createClass(CodeEditor, [{
    ...
    value: function setupEditor(instanceSettings, langOptions) {
      this.loadExtensions();
      var editor = window['ace'].edit(this.options.editorsElement, instanceSettings);
      editor._langOptions = langOptions;
      var options = this.getOptions(langOptions);
      editor.setOptions(options);
      this.syncTextareaAndEditor(editor, langOptions);
    ...
    value: function syncTextareaAndEditor(editor, langOptions) {
      var _this2 = this;
      // to avoid recursion
