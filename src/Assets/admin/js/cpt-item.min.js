...
var CodeEditor = /*#__PURE__*/function () {
  function CodeEditor(enginesStorage, tab, textarea, isReadOnly) {
  ...
  _createClass(CodeEditor, [{
    key: "setupEditor",
    value: function setupEditor(editorsElement, instanceSettings, langOptions) {
      this.loadExtensions();
      var editor = window['ace'].edit(editorsElement, instanceSettings);
    ...
    value: function getInputValue(langOptions) {
      ...
      return this.enginesStorage.unpackTemplate(value, langOptions.engine);
    }
  }, {
    key: "setInputValue",
    value: function setInputValue(value, langOptions) {
      this.textarea.value = this.enginesStorage.packTemplate(value, langOptions.engine);
    }
  }, {
    ...
    value: function syncTextareaAndEditor(editor, langOptions) {
      ...
      editor.getSession().on('change', function () {
        ...
        _this2.textarea.dispatchEvent(new Event('change'));
      ...
      this.textarea.addEventListener('change', function () {
        ...
        if (_this2.tab.classList.contains('active')) {
          return;
        }
        var resize = function resize() {
          editor.resize();
          _this2.tab.removeEventListener('click', resize);
        };
        _this2.tab.addEventListener('click', resize);
      });
    }
  }, {
    ...
    value: function registerCompleter(langTools) {
      ...
      langTools.addCompleter({
        getCompletions: function getCompletions(editor, session, position, prefix, callback) {
          ...
          var interpreter = _this3.enginesStorage.resolveInterpreter(langOptions.engine);
          if (interpreter) {
...
var CodeField = /*#__PURE__*/function (_MyElement) {
  ...
  _createClass(CodeField, [{
    ...
    value: function make() {
      ...
      var codeEditor = new _code_editor__WEBPACK_IMPORTED_MODULE_2__.CodeEditor(this.enginesStorage, this.tab, this.textarea, this.isReadOnly);
      codeEditor.setupEditor(editorsElement, modeSettings[this.langOptions.mode], this.langOptions);
...
var RefreshRequest = /*#__PURE__*/function () {
  ...
  _createClass(RefreshRequest, [{
    ...
    value: function reload(acfFields, data) {
      var _this = this;
      if (!data.hasOwnProperty('textareaItems') || !data.hasOwnProperty('elements') || !data.hasOwnProperty('autocompleteVariables')) {
