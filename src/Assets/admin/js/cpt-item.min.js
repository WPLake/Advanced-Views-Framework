...
var EnginesStorage = /*#__PURE__*/function () {
  ...
  _createClass(EnginesStorage, [{
    ...
    value: function unpackTemplate(template, engine) {
      var _a;
      var meta = ((_a = this.meta[engine]) === null || _a === void 0 ? void 0 : _a.provocativeSymbolsMap) || {};
      for (var _i2 = 0, _Object$entries = Object.entries(meta); _i2 < _Object$entries.length; _i2++) {
        ...
        template = template.replace(mock, value);
      }
      return template;
    }
  }, {
    ...
    value: function packTemplate(template, engine) {
      ...
      for (var _i3 = 0, _Object$entries2 = Object.entries(meta); _i3 < _Object$entries2.length; _i3++) {
        ...
        template = template.replace(value, mock);
      }
      return template;
    }
  }, {
    ...
    value: function initTwig(autocompleteVariables) {
      var _a, _b;
      var engine = 'twig';
      this.interpreters[engine] = new _template_interpreter__WEBPACK_IMPORTED_MODULE_0__.TwigTemplateInterpreter(autocompleteVariables, ((_a = this.meta[engine]) === null || _a === void 0 ? void 0 : _a.autocompleteFunctions) || {}, ((_b = this.meta[engine]) === null || _b === void 0 ? void 0 : _b.autocompleteFilters) || {});
    }
  }]);
