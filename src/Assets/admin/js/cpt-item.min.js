...
var CodeEditor = /*#__PURE__*/function () {
  ...
  _createClass(CodeEditor, [{
    ...
    value: function setInputValue(value) {
      var template = this.options.enginesStorage.packTemplate(value, this.langOptions.engine);
      this.options.textarea.value = template;
    }
  }, {
    ...
    value: function registerCompleter(langTools) {
      ...
      langTools.addCompleter({
        getCompletions: function getCompletions(editor, session, position, prefix, callback) {
          ...
          var interpreter = _this4.options.enginesStorage.resolveInterpreter(langOptions.engine);
          if (interpreter) {
  ...
  _createClass(PostBox, [{
    ...
    value: function createCodeFields() {
      ...
      _settings__WEBPACK_IMPORTED_MODULE_3__["default"]['markupTextarea'].forEach(function (markupTextarea) {
        if (!markupTextarea.hasOwnProperty('idSelector') || !markupTextarea.hasOwnProperty('mode') || !markupTextarea.hasOwnProperty('engine') || !markupTextarea.hasOwnProperty('isReadOnly') || !markupTextarea.hasOwnProperty('linkTitle') || !markupTextarea.hasOwnProperty('tabIdSelector')) {
