...
var Card = /*#__PURE__*/function (_PostBox) {
  ...
  _createClass(Card, [{
    ...
    value: function initializePreview() {
      if (!Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_1__["default"], 'cardPreview') || !Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_1__["default"].cardPreview, 'HTML') || !Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_1__["default"].cardPreview, 'CSS') || !Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_1__["default"].cardPreview, 'HOME')) {
...
var FieldLabelTooltip = /*#__PURE__*/function () {
  ...
  _createClass(FieldLabelTooltip, [{
    ...
    value: function initialize() {
      var _this = this;
      if (!Object.hasOwn(window, 'MutationObserver')) {
        console.log("AcfViews : MutationObserver doesn't supported");
        return '';
      }
      this.addListeners(document.body);
      var observer = new MutationObserver(function (records, _observer) {
    ...
    value: function maybeShowTooltip(label) {
      // already visible
      if (Object.hasOwn(label.dataset, 'tooltip')) {
        return;
      }
    ...
    value: function addListeners(element) {
      ...
      element.querySelectorAll('.acf-field .acf-label label').forEach(function (label) {
        var _label$nextSibling;
        // skip if there are no instructions
        if (!((_label$nextSibling = label.nextSibling) !== null && _label$nextSibling !== void 0 && _label$nextSibling.classList.contains('description'))) {
          return;
        }
...
var FieldSelect = /*#__PURE__*/function (_MyElement) {
  ...
  function FieldSelect(mainSelectId, subSelectId, identifierInputId, isFieldsOnly) {
    ...
    _defineProperty(_assertThisInitialized(_this), "mainSelectId", void 0);
    _defineProperty(_assertThisInitialized(_this), "subSelectId", void 0);
    _defineProperty(_assertThisInitialized(_this), "identifierInputId", void 0);
    _defineProperty(_assertThisInitialized(_this), "isGlobalSelect", void 0);
    _defineProperty(_assertThisInitialized(_this), "globalParentFieldSelect", void 0);
    _defineProperty(_assertThisInitialized(_this), "isFieldsOnly", void 0);
  ...
  _createClass(FieldSelect, [{
    ...
    value: function addListeners(element) {
      ...
      var globalGroupSelect = false === this.isGlobalSelect ? document.body.querySelector("select[id=\"".concat(GLOBAL_GROUP_SELECT_ID, "\"]")) : null;
      this.globalParentFieldSelect = false === this.isGlobalSelect ? document.body.querySelector("select[id=\"".concat(GLOBAL_PARENT_FIELD_SELECT_ID, "\"]")) : null;
      var selector = false === this.isGlobalSelect ? "select[id*=\"".concat(this.mainSelectId, "\"]") : "select[id=\"".concat(this.mainSelectId, "\"]");
      element.querySelectorAll(selector).forEach(function (mainSelect, _index) {
        ...
        (0,_jquery__WEBPACK_IMPORTED_MODULE_1__["default"])(mainSelect).on('change', function (_event) {
        ...
        if (null !== globalGroupSelect) {
          // it's necessary to use jQuery.on('change'), because select2 doesn't trigger ordinary JS onChange
          (0,_jquery__WEBPACK_IMPORTED_MODULE_1__["default"])(globalGroupSelect).on('change', function (_event) {
        ...
        if (null !== _this3.globalParentFieldSelect) {
          // it's necessary to use jQuery.on('change'), because select2 doesn't trigger ordinary JS onChange
          (0,_jquery__WEBPACK_IMPORTED_MODULE_1__["default"])(_this3.globalParentFieldSelect).on('change', function (_event) {
            (0,_jquery__WEBPACK_IMPORTED_MODULE_1__["default"])(mainSelect).val(globalGroupSelect.value).trigger('change');
          });
        }
      });
      selector = false === this.isGlobalSelect ? "select[id*=\"".concat(this.subSelectId, "\"]") : "select[id=\"".concat(this.subSelectId, "\"]");
      element.querySelectorAll(selector).forEach(function (subSelect, _index) {
    ...
    value: function updateAvailableFields(mainSelect, value) {
      ...
      var selector = false === this.isGlobalSelect ? "select[id*=\"".concat(this.subSelectId, "\"]") : "select[id=\"".concat(this.subSelectId, "\"]");
    ...
    value: function getUniqueIdWithinScope(scope, id) {
      ...
      return this.getUniqueIdWithinScope(scope, "".concat(id, "2"));
    }
  }, {
    key: "getFieldLabelInEnglish",
    value: function getFieldLabelInEnglish(chosenFieldKey) {
      if (false === Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_2__["default"], 'allFieldChoicesInEnglish') || false === Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_2__["default"].allFieldChoicesInEnglish, chosenFieldKey)) {
    ...
    value: function generateFieldIdentifierIfPresent(rowSelect) {
      ...
      var identifierInput = row.querySelector("input[id*=\"".concat(this.identifierInputId, "\"]"));
      // can be not present (on the Card Meta Filters tab)
      if (!identifierInput) {
        return;
      }
      var chosenOption = rowSelect.querySelector("select[id*=\"".concat(this.subSelectId, "\"] option:checked"));
...
var FieldsChangedNotice = /*#__PURE__*/function () {
  function FieldsChangedNotice() {
    ...
    _defineProperty(this, "changedInputs", void 0);
    _defineProperty(this, "highlightedTabs", void 0);
    _defineProperty(this, "initialFieldValues", void 0);
    _defineProperty(this, "isWithRemovedRows", void 0);
    this.changedInputs = [];
  ...
  _createClass(FieldsChangedNotice, [{
    ...
    value: function getCurrentFieldValue(input) {
      ...
      var isMultipleSelect = Object.hasOwn(input.dataset, 'multiple') && '1' === input.dataset.multiple;
    ...
    value: function changeTabAmendedInputsNumber(field, isChanged) {
      ...
      // tab field can missing (e.g. the Title field)
      if (!tabField) {
        return;
      }
      ...
      var tabMenuItem = tabWrap.querySelector(".acf-tab-button[data-key=\"".concat(tabKey, "\"]"));
      var amendedInputsNumber = Object.hasOwn(tabMenuItem.dataset, 'amendedInputsNumber') ? parseInt(tabMenuItem.dataset.amendedInputsNumber, 10) : 0;
      if (isChanged) {
        amendedInputsNumber++;
      } else {
        amendedInputsNumber--;
    ...
    value: function toggleInputState(event) {
      ...
      if (Object.hasOwn(input.dataset, 'acfViewsRefresh')) {
    ...
    value: function reset() {
      ...
      for (var tabKey in this.highlightedTabs) {
        var tabMenuItem = document.querySelector(".acf-tab-button[data-key=\"".concat(tabKey, "\"]"));
    ...
    value: function setup() {
      ...
      // pay attention that WP editor (wp-includes/js/dist/editor.js) also has its own leave warning on:
      // wp.data.select('core').__experimentalGetDirtyEntityRecords?.() when length > 0
      window.addEventListener('beforeunload', function (event) {
        var hasChanges = _this3.changedInputs.length > 0 || _this3.isWithRemovedRows;
        if (hasChanges) {
...
/***/ "./lite/admin/js/cpt-item/git-meta-box.ts":
/*!************************************************!*\
  !*** ./lite/admin/js/cpt-item/git-meta-box.ts ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _lite_admin_js_cpt_item_web_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../lite/admin/js/cpt-item/web-component */ "./lite/admin/js/cpt-item/web-component.ts");
/* harmony import */ var _lite_admin_js_cpt_item_settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../lite/admin/js/cpt-item/settings */ "./lite/admin/js/cpt-item/settings.ts");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var AJAX_ACTION_PREFIX = 'acf-views__git_meta_box_';
var GitMetaBox = /*#__PURE__*/function (_WebComponent) {
  _inherits(GitMetaBox, _WebComponent);
  var _super = _createSuper(GitMetaBox);
  function GitMetaBox() {
    var _this;
    _classCallCheck(this, GitMetaBox);
    ...
    _defineProperty(_assertThisInitialized(_this), "nonceInput", void 0);
    _defineProperty(_assertThisInitialized(_this), "wpData", void 0);
    _defineProperty(_assertThisInitialized(_this), "ajaxUrl", void 0);
    return _this;
  }
  _createClass(GitMetaBox, [{
    key: "getPostType",
    value: function getPostType() {
      var postType = '';
      document.body.classList.forEach(function (className) {
        if (false === className.startsWith('post-type-')) {
          return;
        }
        postType = className.replace('post-type-', '');
      });
      return postType;
    }
  }, {
    ...
    value: function submit(e) {
      var _this2 = this;
      // we don't need to submit the global meta boxes form
      e.preventDefault();
      e.stopImmediatePropagation();
      e.stopPropagation();
      var chosenRepositoryId = this.select.value;
      if ('' === chosenRepositoryId) {
        alert('Please choose a repository');
        return;
      }
      this.style.opacity = '0.5';
      this.style.pointerEvents = 'none';
      var formData = new FormData();
      formData.append('action', AJAX_ACTION_PREFIX + this.getPostType());
      formData.append('_postId', this.wpData.select('core/editor').getCurrentPostId());
      formData.append('_repositoryId', chosenRepositoryId);
      formData.append('_isWithMetaGroups', true === this.checkbox.checked ? '1' : '0');
      formData.append('_wpnonce', this.nonceInput.value);
      ...
      request.addEventListener('readystatechange', function () {
        ...
        var initialText = _this2.button.innerText;
        _this2.button.innerText = request.responseText;
        _this2.style.opacity = null;
        setTimeout(function () {
          _this2.button.innerText = initialText;
          _this2.style.pointerEvents = null;
        }, 5000);
      });
    ...
    key: "initialize",
    value: function initialize() {
      _get(_getPrototypeOf(GitMetaBox.prototype), "initialize", this).call(this);
      if (false === Object.hasOwn(_lite_admin_js_cpt_item_settings__WEBPACK_IMPORTED_MODULE_1__["default"], 'ajaxUrl')) {
        throw new Error('Ajax url is missing');
      }
      this.ajaxUrl = _lite_admin_js_cpt_item_settings__WEBPACK_IMPORTED_MODULE_1__["default"].ajaxUrl;
      this.wpData = window.wp.data;
      this.select = this.querySelector('select');
      this.button = this.querySelector('button');
      this.checkbox = this.querySelector('input[type="checkbox"]');
      this.nonceInput = this.querySelector('input[type="hidden"]');
      this.button.addEventListener('click', this.submit.bind(this));
    }
  }]);
  return GitMetaBox;
}(_lite_admin_js_cpt_item_web_component__WEBPACK_IMPORTED_MODULE_0__["default"]);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (GitMetaBox);

/***/ }),

/***/ "./lite/admin/js/cpt-item/interactive-fields/code-editor.ts":
/*!******************************************************************!*\
  !*** ./lite/admin/js/cpt-item/interactive-fields/code-editor.ts ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var CodeEditor = /*#__PURE__*/function () {
  function CodeEditor(options) {
    ...
    _defineProperty(this, "langOptions", void 0);
    _defineProperty(this, "instanceSettings", void 0);
    this.options = options;
  }
  _createClass(CodeEditor, [{
    key: "setupEditor",
    value: function setupEditor(instanceSettings, langOptions) {
      this.langOptions = langOptions;
      this.instanceSettings = instanceSettings;
      this.loadExtensions();
      this.editor = window.ace.edit(this.options.editorsElement, instanceSettings);
      this.setOptions();
      this.bindEditorValueToInput();
      this.extensionBeautify();
      this.extensionLinking();
      // todo remove if the 'worker-css' adds the nesting rules support.
      // https://github.com/ajaxorg/ace/issues/5559
      if ('_css' === langOptions.mode) {
        this.editor.getSession().setUseWorker(false);
      }
    }
  }, {
    key: "reloadEditor",
    value: function reloadEditor(instanceSettings, langOptions) {
      this.langOptions = langOptions;
      this.instanceSettings = instanceSettings;
      this.setOptions();
    ...
    value: function setOptions() {
      this.editor._langOptions = this.langOptions;
    ...
    value: function resolveOptions() {
      ...
      var isLiveAutocompletionEnabled = '_css' !== this.langOptions.mode;
      return Object.assign(this.instanceSettings, {
    ...
    value: function getInputValue() {
      var value = this.options.textarea.value;
      if (this.langOptions.engine) {
        return this.options.enginesStorage.unpackTemplate(value, this.langOptions.engine);
      }
      return value;
    }
  }, {
    ...
    value: function setInputValue(value) {
      if (this.langOptions.engine) {
        value = this.options.enginesStorage.packTemplate(value, this.langOptions.engine);
      }
    ...
    value: function updateEditorValue() {
      ...
      if (this.options.tab.classList.contains('active')) {
        return;
      }
      var resize = function resize() {
        _this2.editor.resize();
        _this2.options.tab.removeEventListener('click', resize);
      };
      this.options.tab.addEventListener('click', resize);
    }
  }, {
    key: "bindEditorValueToInput",
    value: function bindEditorValueToInput() {
      var _this3 = this;
      this.editor.getSession().on('change', function () {
        var value = _this3.editor.getSession().getValue();
        _this3.setInputValue(value);
        // notify potential listeners, e.g. fields-changed notice
        _this3.options.textarea.dispatchEvent(new Event('change'));
      });
    }
  }, {
    key: "extensionBeautify",
    value: function extensionBeautify() {
    ...
    value: function extensionLinking() {
      this.editor.on('linkClick', function (data) {
        var _data$token;
        if ('comment' !== ((_data$token = data.token) === null || _data$token === void 0 ? void 0 : _data$token.type)) {
          return;
        }
    ...
    key: "registerCompleter",
    value: function registerCompleter(langTools) {
      var _this4 = this;
      // we skip the text completer, because it is too generic
      langTools.setCompleters([langTools.keyWordCompleter]);
      langTools.addCompleter({
        getCompletions: function getCompletions(editor, session, position, _prefix, callback) {
          var langOptions = editor._langOptions;
          var interpreter = langOptions.engine ? _this4.options.enginesStorage.resolveInterpreter(langOptions.engine) : undefined;
          if (interpreter) {
            var resolveLine = function resolveLine(line) {
              return session.getLine(line);
            };
            var completions = interpreter.resolveCompletions({
              currentLine: resolveLine(position.row),
...
/***/ "./lite/admin/js/cpt-item/interactive-fields/code-field.ts":
/*!*****************************************************************!*\
  !*** ./lite/admin/js/cpt-item/interactive-fields/code-field.ts ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CodeField: () => (/* binding */ CodeField)
/* harmony export */ });
/* harmony import */ var _my_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../my-element */ "./lite/admin/js/cpt-item/my-element.ts");
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../settings */ "./lite/admin/js/cpt-item/settings.ts");
/* harmony import */ var _code_editor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./code-editor */ "./lite/admin/js/cpt-item/interactive-fields/code-editor.ts");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var CodeField = /*#__PURE__*/function (_MyElement) {
  ...
  function CodeField(enginesStorage, postBox, tab, textarea, langOptions, isReadOnly, linkTitle) {
    var _this;
    _classCallCheck(this, CodeField);
    _this = _super.call(this);
    _defineProperty(_assertThisInitialized(_this), "enginesStorage", void 0);
    _defineProperty(_assertThisInitialized(_this), "postBox", void 0);
    _defineProperty(_assertThisInitialized(_this), "tab", void 0);
    _defineProperty(_assertThisInitialized(_this), "textarea", void 0);
    _defineProperty(_assertThisInitialized(_this), "langOptions", void 0);
    _defineProperty(_assertThisInitialized(_this), "isReadOnly", void 0);
    _defineProperty(_assertThisInitialized(_this), "isToolbarPanelOpen", void 0);
    _defineProperty(_assertThisInitialized(_this), "originalNavItems", void 0);
    _defineProperty(_assertThisInitialized(_this), "linkTitle", void 0);
    _defineProperty(_assertThisInitialized(_this), "makeCallback", void 0);
    _defineProperty(_assertThisInitialized(_this), "fullScreenSwitcher", void 0);
    _defineProperty(_assertThisInitialized(_this), "codeEditor", void 0);
    _defineProperty(_assertThisInitialized(_this), "isSetup", void 0);
    _this.isSetup = false;
    _this.enginesStorage = enginesStorage;
    _this.postBox = postBox;
    _this.tab = tab;
    _this.textarea = textarea;
    _this.langOptions = langOptions;
  ...
  _createClass(CodeField, [{
    ...
    key: "reload",
    value: function reload(langOptions) {
      if (this.isSetup) {
        this.langOptions = langOptions;
        this.codeEditor.reloadEditor(this.resolveEditorInstanceSettings(), langOptions);
      }
    }
  }, {
    key: "initialize",
    value: function initialize() {
      ...
      window.acf.addAction("show_field/name=".concat(this.getFieldName()), this.makeCallback);
    }
  }, {
    key: "make",
    value: function make() {
      if (this.makeCallback) {
        window.acf.removeAction("show_field/name=".concat(this.getFieldName()), this.makeCallback);
      ...
      this.codeEditor = new _code_editor__WEBPACK_IMPORTED_MODULE_2__.CodeEditor({
        enginesStorage: this.enginesStorage,
        tab: this.tab,
        textarea: this.textarea,
        isReadOnly: this.isReadOnly,
        editorsElement: editorsElement
      });
      this.codeEditor.setupEditor(this.resolveEditorInstanceSettings(), this.langOptions);
      this.makeFullScreenModeSwitcher();
      this.isSetup = true;
    }
  }, {
    key: "resolveEditorInstanceSettings",
    value: function resolveEditorInstanceSettings() {
      var settings = _settings__WEBPACK_IMPORTED_MODULE_1__["default"].mods[this.langOptions.mode];
      if ('object' === _typeof(settings)) {
        return settings;
      }
      console.error('Cannot resolve editor instance settings', {
        textarea: this.textarea,
        mode: this.langOptions.mode,
    ...
    value: function toggleFullScreen(_event) {
...
/***/ "./lite/admin/js/cpt-item/interactive-fields/engines-storage.ts":
/*!**********************************************************************!*\
  !*** ./lite/admin/js/cpt-item/interactive-fields/engines-storage.ts ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   EnginesStorage: () => (/* binding */ EnginesStorage)
/* harmony export */ });
/* harmony import */ var _template_interpreter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./template-interpreter */ "./lite/admin/js/cpt-item/interactive-fields/template-interpreter.ts");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var EnginesStorage = /*#__PURE__*/function () {
  function EnginesStorage(meta, autocompleteVariables) {
    _classCallCheck(this, EnginesStorage);
    _defineProperty(this, "interpreters", void 0);
    _defineProperty(this, "meta", void 0);
    this.meta = meta;
    this.interpreters = {};
    this.initTwig(autocompleteVariables);
  }
  _createClass(EnginesStorage, [{
    key: "setAutocompleteVariables",
    value: function setAutocompleteVariables(variables) {
      for (var _i = 0, _Object$values = Object.values(this.interpreters); _i < _Object$values.length; _i++) {
        var interpreter = _Object$values[_i];
        interpreter.setAutocompleteVariables(variables);
      }
    }
  }, {
    key: "resolveInterpreter",
    value: function resolveInterpreter(engine) {
      return this.interpreters[engine];
    }
    // PHP is stripped on ACF field_load hook to avoid issues with security plugins like WordFence
  }, {
    key: "unpackTemplate",
    value: function unpackTemplate(template, engine) {
      var _this$meta$engine;
      var meta = ((_this$meta$engine = this.meta[engine]) === null || _this$meta$engine === void 0 ? void 0 : _this$meta$engine.provocativeSymbolsMap) || {};
      for (var _i2 = 0, _Object$entries = Object.entries(meta); _i2 < _Object$entries.length; _i2++) {
        var _Object$entries$_i = _slicedToArray(_Object$entries[_i2], 2),
          value = _Object$entries$_i[0],
          mock = _Object$entries$_i[1];
        template = template.replaceAll(mock, value);
      }
      return template;
    }
  }, {
    key: "packTemplate",
    value: function packTemplate(template, engine) {
      var _this$meta$engine2;
      var meta = ((_this$meta$engine2 = this.meta[engine]) === null || _this$meta$engine2 === void 0 ? void 0 : _this$meta$engine2.provocativeSymbolsMap) || {};
      for (var _i3 = 0, _Object$entries2 = Object.entries(meta); _i3 < _Object$entries2.length; _i3++) {
        var _Object$entries2$_i = _slicedToArray(_Object$entries2[_i3], 2),
          value = _Object$entries2$_i[0],
          mock = _Object$entries2$_i[1];
        template = template.replaceAll(value, mock);
      }
      return template;
    }
  }, {
    key: "initTwig",
    value: function initTwig(autocompleteVariables) {
      var _this$meta$engine3, _this$meta$engine4;
      var engine = 'twig';
      this.interpreters[engine] = new _template_interpreter__WEBPACK_IMPORTED_MODULE_0__.TwigTemplateInterpreter(autocompleteVariables, ((_this$meta$engine3 = this.meta[engine]) === null || _this$meta$engine3 === void 0 ? void 0 : _this$meta$engine3.autocompleteFunctions) || {}, ((_this$meta$engine4 = this.meta[engine]) === null || _this$meta$engine4 === void 0 ? void 0 : _this$meta$engine4.autocompleteFilters) || {});
    }
  }]);
...
/***/ "./lite/admin/js/cpt-item/interactive-fields/refresh-request.ts":
/*!**********************************************************************!*\
  !*** ./lite/admin/js/cpt-item/interactive-fields/refresh-request.ts ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   RefreshRequest: () => (/* binding */ RefreshRequest)
/* harmony export */ });
...
var RefreshRequest = /*#__PURE__*/function () {
  function RefreshRequest(postbox, enginesStorage, textareas, refreshRoute, refreshNonce) {
    _classCallCheck(this, RefreshRequest);
    _defineProperty(this, "enginesStorage", void 0);
    _defineProperty(this, "postbox", void 0);
    _defineProperty(this, "isSent", void 0);
    _defineProperty(this, "wpData", void 0);
    _defineProperty(this, "refreshRoute", void 0);
    _defineProperty(this, "refreshNonce", void 0);
    _defineProperty(this, "textareas", void 0);
  ...
  _createClass(RefreshRequest, [{
    ...
    value: function reload(acfFields, data) {
      var requiredProps = ['textareaItems', 'elements', 'autocompleteVariables', 'editorsData'];
      ...
      if (missingProps.length > 0) {
        ...
        throw new Error('Ajax response is wrong');
      }
      this.refreshTextareas(data.textareaItems, data.editorsData);
      ...
      this.enginesStorage.setAutocompleteVariables(data.autocompleteVariables);
    }
  }, {
    key: "refreshTextareas",
    value: function refreshTextareas(items, editorsData) {
      var _this = this;
      var _loop = function _loop() {
        var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
          fieldId = _Object$entries$_i[0],
          value = _Object$entries$_i[1];
        var textarea = _this.resolveTextareaElement(fieldId);
        var codeField = _this.postbox.getCodeFieldById(fieldId);
        var editorData = editorsData.find(function (editorData) {
          return editorData.idSelector === fieldId;
        });
        if (textarea && codeField && editorData) {
          // null means we should keep it the same and update only the mode (e.g. for CustomMarkup).
          if (null !== value) {
            textarea.value = value;
          }
          codeField.reload({
            mode: editorData.mode,
            engine: editorData.engine
          });
        } else {
          console.log('CodeField to refresh', {
            fieldId: fieldId,
            editorData: editorData,
            editorsData: editorsData
          });
          throw new Error('Failed to refresh CodeField');
        }
      };
    ...
    key: "resolveTextareaElement",
    value: function resolveTextareaElement(textareaId) {
      return this.textareas.find(function (textarea) {
    ...
    value: function makeRequest() {
      ...
      fetch("/wp-json/acf_views/v1".concat(this.refreshRoute), {
        method: 'POST',
        headers: {
        ...
        return _this2.reload(acfFields, response);
    ...
    value: function switchOnUpdatedNotification() {
      var notifications = document.querySelector('.edit-post-layout__snackbar');
    ...
    value: function maybeTriggerSaved() {
      ...
      var isSavingFlag = Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_0__["default"], 'isWordpressComHosting') && _settings__WEBPACK_IMPORTED_MODULE_0__["default"].isWordpressComHosting ? isSavingMetaBoxes : isSavingPost;
...
/***/ "./lite/admin/js/cpt-item/interactive-fields/template-interpreter.ts":
/*!***************************************************************************!*\
  !*** ./lite/admin/js/cpt-item/interactive-fields/template-interpreter.ts ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TwigTemplateInterpreter: () => (/* binding */ TwigTemplateInterpreter)
/* harmony export */ });
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var TwigTemplateInterpreter = /*#__PURE__*/function () {
  function TwigTemplateInterpreter(variables, functions, filters) {
    _classCallCheck(this, TwigTemplateInterpreter);
    _defineProperty(this, "autocompleteVariables", void 0);
    _defineProperty(this, "autocompleteFunctions", void 0);
    _defineProperty(this, "autocompleteFilters", void 0);
    this.autocompleteVariables = variables;
    this.autocompleteFunctions = functions;
    this.autocompleteFilters = filters;
  }
  _createClass(TwigTemplateInterpreter, [{
    key: "setAutocompleteVariables",
    value: function setAutocompleteVariables(autocompleteVariables) {
      this.autocompleteVariables = autocompleteVariables;
    }
  }, {
    key: "resolveCompletions",
    value: function resolveCompletions(prompt) {
      var currentLine = prompt.currentLine,
        columnIndex = prompt.columnIndex;
      if (!this.isTwigLine(currentLine)) {
        return;
      }
      var spaceIndex = currentLine.lastIndexOf(' ', columnIndex - 1);
      var variableName = currentLine.substring(spaceIndex + 1, columnIndex);
      return [].concat(_toConsumableArray(this.getVariablesAutocomplete(variableName, prompt)), _toConsumableArray(this.getFunctionsAutocomplete(variableName)), _toConsumableArray(this.getFiltersAutocomplete(variableName)));
    }
  }, {
    key: "isTwigLine",
    ...
    key: "getCurrentLoops",
    value: function getCurrentLoops(prompt) {
      var loopsData = [];
      var closedLoops = 0;
      var lineIndex = prompt.lineIndex,
        resolveLine = prompt.resolveLine;
      // begin from the previous line
      for (var line = lineIndex - 1; line > 0; line--) {
        var lineText = resolveLine(line);
    ...
    value: function getLoopItemVariables(variableParts, scope) {
      ...
      scope = Object.hasOwn(scope, mainKey) ? scope[mainKey] : {};
      return Object.hasOwn(scope, subKey) && scope[subKey].length > 0 ? scope[subKey][0] : {};
    }
  }, {
    key: "getLoopVariablesAutocomplete",
    value: function getLoopVariablesAutocomplete(nameParts, prompt, isGlobalVar) {
      var _this = this;
      var variablesInfo = [];
      ...
      var parentLoopsData = this.getCurrentLoops(prompt);
      if (isGlobalVar) {
      ...
      switch (loopScopeParts.length) {
        ...
        case 2:
          ...
          if (2 === nameParts.length) {
            ...
            autoCompleteData = Object.hasOwn(autoCompleteData, propertyName) ? autoCompleteData[propertyName] : {};
          }
          break;
        // ['item', 'gallery', 'value', ]
        case 3:
    ...
    value: function getVariablesAutocomplete(variableName, prompt) {
      // ignore filters
      ...
      return [].concat(_toConsumableArray(this.getContextVariablesAutocomplete(nameParts, isGlobalVar)), _toConsumableArray(this.getLoopVariablesAutocomplete(nameParts, prompt, isGlobalVar)));
    }
  }, {
    ...
    value: function getFunctionsAutocomplete(functionName) {
      ...
      for (var _functionName in this.autocompleteFunctions) {
        functionsAutocomplete.push(this.makeAutocompleteItem("".concat(_functionName, "()"), null, 1000, null, _functionName + this.autocompleteFunctions[_functionName]));
      }
  ...
  return TwigTemplateInterpreter;
}();
...
var jQuery = Object.hasOwn(window, 'jQuery') ? window.jQuery : null;
if (!jQuery) {
...
/* harmony import */ var _interactive_fields_code_field__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./interactive-fields/code-field */ "./lite/admin/js/cpt-item/interactive-fields/code-field.ts");
...
/* harmony import */ var _interactive_fields_refresh_request__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./interactive-fields/refresh-request */ "./lite/admin/js/cpt-item/interactive-fields/refresh-request.ts");
/* harmony import */ var _interactive_fields_engines_storage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./interactive-fields/engines-storage */ "./lite/admin/js/cpt-item/interactive-fields/engines-storage.ts");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var PostBox = /*#__PURE__*/function (_MyElement) {
  ...
  function PostBox() {
    ...
    _this = _super.call(this);
    _defineProperty(_assertThisInitialized(_this), "codeFields", void 0);
    _defineProperty(_assertThisInitialized(_this), "enginesStorage", void 0);
    _this.codeFields = [];
    _this.enginesStorage = new _interactive_fields_engines_storage__WEBPACK_IMPORTED_MODULE_7__.EnginesStorage(_settings__WEBPACK_IMPORTED_MODULE_3__["default"].enginesMeta, _settings__WEBPACK_IMPORTED_MODULE_3__["default"].autocompleteVariables);
    return _this;
  }
  _createClass(PostBox, [{
    ...
    value: function createCodeFields() {
      var _this2 = this;
      if (!Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_3__["default"], 'markupTextarea')) {
        throw new Error('Required argument is missing: markupTextarea');
      }
      _settings__WEBPACK_IMPORTED_MODULE_3__["default"].markupTextarea.forEach(function (markupTextarea) {
        var requiredArguments = ['idSelector', 'mode',
        // engine is optional.
        'isReadOnly', 'linkTitle', 'tabIdSelector'];
        var missingArguments = requiredArguments.filter(function (arg) {
          return !Object.hasOwn(markupTextarea, arg);
        });
        if (missingArguments.length > 0) {
          ...
          throw new Error('CodeFields: Required argument is missing');
        }
        var textarea = document.body.querySelector("textarea[id=\"".concat(markupTextarea.idSelector, "\"]"));
        if (!textarea) {
          throw new Error("Textarea not found: #".concat(markupTextarea.idSelector));
        }
        var tab = document.body.querySelector(".acf-tab-button[data-key=\"".concat(markupTextarea.tabIdSelector, "\"]")).parentElement;
        var codeField = new _interactive_fields_code_field__WEBPACK_IMPORTED_MODULE_2__.CodeField(_this2.enginesStorage, _this2, tab, textarea, {
          mode: markupTextarea.mode,
          // can be undefined.
          engine: markupTextarea.engine
        }, markupTextarea.isReadOnly, markupTextarea.linkTitle);
    ...
    value: function createFieldSelects() {
      if (!Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_3__["default"], 'fieldSelect')) {
      ...
      _settings__WEBPACK_IMPORTED_MODULE_3__["default"].fieldSelect.forEach(function (fieldSelect) {
        if (!Object.hasOwn(fieldSelect, 'mainSelectId') || !Object.hasOwn(fieldSelect, 'subSelectId') || !Object.hasOwn(fieldSelect, 'identifierInputId')) {
          throw new Error('Required property is missing');
        }
        var isFieldsOnly = true === Object.hasOwn(fieldSelect, 'isFieldsOnly') && true === fieldSelect.isFieldsOnly;
    ...
    // without the initial title, WP doesn't allow saving a new Post -
    // meanwhile, our title is in ACF field.
  }, {
    key: "bindPostTitleField",
    value: function bindPostTitleField() {
      var wp = window.wp.data;
      // class is the same for both Layouts & Post Selections, and assigned by the PHPDoc field attribute.
      var titleInput = document.querySelector('.advanced-views__title input');
      var getPostTitle = function getPostTitle() {
        var title = wp.select('core/editor').getEditedPostAttribute('title');
      ...
      var setPostTitle = function setPostTitle(title) {
        return wp.dispatch('core/editor').editPost({
          title: title
        });
      };
      if (titleInput instanceof HTMLInputElement) {
        titleInput.addEventListener('change', function () {
          var inputValue = titleInput.value.trim();
          setPostTitle(inputValue);
        });
      } else {
        console.error('AV: cannot bind titleInput - it is not an HTMLInputElement');
      }
      var unsubscribe = wp.subscribe(function () {
        var postTitle = getPostTitle();
        // it's undefined until Gutenberg is completely loaded.
        if ('string' === typeof postTitle) {
          unsubscribe();
          if (0 === postTitle.length) {
            setPostTitle('Default Title');
          }
        }
      });
    }
    ...
    value: function suppressAcfTabsRemembering() {
      window.addEventListener('beforeunload', function (_event) {
        var acf = window.acf;
        acf.setPreference("tabs-".concat(acf.get('post_id')), null);
      });
    }
  }, {
    key: "setupRefreshAjax",
    value: function setupRefreshAjax() {
      var refreshRoute = Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_3__["default"], 'refreshRoute') ? _settings__WEBPACK_IMPORTED_MODULE_3__["default"].refreshRoute : '';
      var refreshNonce = Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_3__["default"], 'refreshNonce') ? _settings__WEBPACK_IMPORTED_MODULE_3__["default"].refreshNonce : '';
      var textareaItemsToRefresh = Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_3__["default"], 'textareaItemsToRefresh') ? _settings__WEBPACK_IMPORTED_MODULE_3__["default"].textareaItemsToRefresh : [];
      var textareaItems = [];
      textareaItemsToRefresh.forEach(function (textareaItemId) {
        var textarea = document.querySelector("#".concat(textareaItemId));
        if (!textarea) {
          return;
        }
      ...
      if (textareaItems.length !== textareaItemsToRefresh.length || !refreshRoute || !refreshNonce) {
        ...
        throw new Error('Fail to setup refresh request');
      }
      new _interactive_fields_refresh_request__WEBPACK_IMPORTED_MODULE_6__.RefreshRequest(this, this.enginesStorage, textareaItems, refreshRoute, refreshNonce);
    }
  }, {
    key: "init",
    value: function init() {
      this.bindPostTitleField();
...
var Preview = /*#__PURE__*/function () {
  function Preview(tabSelector, previewFieldSelector, html, css, homeUrl) {
    ...
    _defineProperty(this, "previewField", void 0);
    _defineProperty(this, "html", void 0);
    _defineProperty(this, "css", void 0);
    _defineProperty(this, "homeUrl", void 0);
    _defineProperty(this, "extraCss", void 0);
  ...
  _createClass(Preview, [{
    ...
    value: function initialize() {
      ...
      var isInit = false;
      this.tab.addEventListener('click', function (_event) {
        if (isInit) {
          return;
        }
        isInit = true;
    ...
    value: function createFiddle(stylesheets, styles) {
      ...
      fiddle.dataset.prefill = encodeURI(JSON.stringify({
        ...
        head: "".concat(styles, "<style>body{padding:20px;}").concat(this.extraCss, "</style>")
      }));
...
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./settings */ "./lite/admin/js/cpt-item/settings.ts");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
var _excluded = ["url", "path", "data", "parse"];
...
var parseJsonAndNormalizeError = function parseJsonAndNormalizeError(response) {
  var invalidJsonError = {
    code: 'invalid_json',
    message: external_wp_i18n_namespaceObject.__('The response is not a valid JSON response.')
  };
  if (!(response !== null && response !== void 0 && response.json)) {
...
function parseAndThrowError(response) {
  ...
  return parseJsonAndNormalizeError(response).then(function (error) {
    var unknownError = {
      code: 'unknown_error',
      message: external_wp_i18n_namespaceObject.__('An unknown error occurred.')
    };
...
window.wp.apiFetch.setFetchHandler(function (nextOptions) {
  var url = nextOptions.url,
    ...
    remainingOptions = _objectWithoutProperties(nextOptions, _excluded);
  ...
  var isWordpressComHosting = Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_0__["default"], 'isWordpressComHosting') && _settings__WEBPACK_IMPORTED_MODULE_0__["default"].isWordpressComHosting;
  ...
  var isPostboxRequestRequired = Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_0__["default"], 'isPostboxRequestRequired') && _settings__WEBPACK_IMPORTED_MODULE_0__["default"].isPostboxRequestRequired;
  ...
  return responsePromise.then(function (value) {
    ...
    throw {
      code: 'fetch_error',
      message: external_wp_i18n_namespaceObject.__('You are probably offline.')
    };
  });
});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var ACF_VIEWS = Object.hasOwn(window, 'acf_views') ? window.acf_views : null;
if (!ACF_VIEWS) {
...
var View = /*#__PURE__*/function (_PostBox) {
  ...
  _createClass(View, [{
    ...
    key: "initializePreview",
    value: function initializePreview() {
      if (!Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_1__["default"], 'viewPreview') || !Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_1__["default"].viewPreview, 'HTML') || !Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_1__["default"].viewPreview, 'CSS') || !Object.hasOwn(_settings__WEBPACK_IMPORTED_MODULE_1__["default"].viewPreview, 'HOME')) {
        console.log('Preview properties are missing');
        return;
      }
...
/* harmony import */ var _cpt_item_git_meta_box__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cpt-item/git-meta-box */ "./lite/admin/js/cpt-item/git-meta-box.ts");
...
customElements.define('av-git-meta-box', _cpt_item_git_meta_box__WEBPACK_IMPORTED_MODULE_4__["default"]);
