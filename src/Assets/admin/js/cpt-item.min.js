  ...
  _createClass(GitMetaBox, [{
    ...
    value: function submit(e) {
      ...
      request.addEventListener('readystatechange', function () {
        ...
        var initialText = _this.button.innerText;
        _this.button.innerText = request.responseText;
        _this.style.opacity = null;
        setTimeout(function () {
          _this.button.innerText = initialText;
          _this.style.pointerEvents = null;
        }, 5000);
      });
    ...
    value: function initialize() {
      ...
      if (false === _lite_admin_js_cpt_item_settings__WEBPACK_IMPORTED_MODULE_1__["default"].hasOwnProperty('ajaxUrl')) {
...
var CodeField = /*#__PURE__*/function (_MyElement) {
  ...
  _createClass(CodeField, [{
    ...
    value: function reload(langOptions) {
      if (this.isSetup) {
        this.langOptions = langOptions;
        this.codeEditor.reloadEditor(this.getEditorInstanceSettings(), langOptions);
      }
    }
  }, {
    key: "initialize",
    value: function initialize() {
      ...
      window['acf'].addAction('show_field/name=' + this.getFieldName(), this.makeCallback);
    }
  }, {
    key: "make",
    value: function make() {
      if (this.makeCallback) {
        window['acf'].removeAction('show_field/name=' + this.getFieldName(), this.makeCallback);
      ...
      this.codeEditor.setupEditor(this.getEditorInstanceSettings(), this.langOptions);
      this.makeFullScreenModeSwitcher();
      this.isSetup = true;
    }
  }, {
    key: "getEditorInstanceSettings",
    value: function getEditorInstanceSettings() {
      return _settings__WEBPACK_IMPORTED_MODULE_1__["default"]['mods'][this.langOptions.mode];
    }
  }, {
    ...
    value: function createCodeFields() {
      ...
      _settings__WEBPACK_IMPORTED_MODULE_3__["default"]['markupTextarea'].forEach(function (markupTextarea) {
        ...
        var missingArguments = requiredArguments.filter(function (arg) {
          return !markupTextarea.hasOwnProperty(arg);
        });
        ...
        if (!textarea) {
          throw new Error('Textarea not found: #' + markupTextarea.idSelector);
        }
