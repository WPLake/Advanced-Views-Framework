...
use Org\Wplake\Advanced_Views\Template\Engines\PHP\PHP_Integration;
...
use Org\Wplake\Advanced_Views\Template\Engines\Twig\Twig_Integration;
...
class Engines_Storage {
	...
	public function __construct( string $uploads_folder, Logger $logger, Settings $settings ) {
