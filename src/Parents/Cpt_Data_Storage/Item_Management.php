...
abstract class Item_Management extends Action {
	...
	protected function make_new(
		...
		$unique_id_field_name = Layouts_Feature::cpt_name() === $this->db_management->get_post_type() ?
		...
		$title_field_name     = Layouts_Feature::cpt_name() === $this->db_management->get_post_type() ?
	...
	public function get_unique_id_from_shortcode_id( string $id, string $post_type ): string {
		// A) short unique id.
		if ( 13 === strlen( $id ) ) {
			$id_prefix = Layouts_Feature::cpt_name() === $post_type ?
